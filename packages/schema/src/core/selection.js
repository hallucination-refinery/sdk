...
export class SelectionUtils {
     ...
     */
    static addNodes(selection, nodeIds) {
     ...
     */
    static addEdges(selection, edgeIds) {
     ...
     */
    static removeNodes(selection, nodeIds) {
        const newNodeIds = new Set(selection.nodeIds);
     ...
     */
    static removeEdges(selection, edgeIds) {
        const newEdgeIds = new Set(selection.edgeIds);
     ...
     */
    static toggleNodes(selection, nodeIds) {
        const newNodeIds = new Set(selection.nodeIds);
        nodeIds.forEach(id => {
     ...
     */
    static toggleEdges(selection, edgeIds) {
        const newEdgeIds = new Set(selection.edgeIds);
        edgeIds.forEach(id => {

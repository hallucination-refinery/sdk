...
export function createInitialCanvasState(overrides?: Partial<CanvasState>): CanvasState {
  return {
    nodes: new Map(),
    edges: new Map(),
...
export function processCanvasCommand(state: CanvasState, command: RendererCommand): CanvasState {

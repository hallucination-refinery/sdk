...
**Conducted:** 2:23 PM EST, 16-08-2025
...
2. Seems to make **no difference** whether clicking on node or background. Console log seems to only recognize clicks (on nodes _or_ background, as background clicks). No visual change.

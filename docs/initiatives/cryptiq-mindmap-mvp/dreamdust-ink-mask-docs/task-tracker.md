...
|------|-------------|-------------|--------|-------|
| Alpha hardcode probe | Force particle alpha to 1.0 or bypass discard to test fragment-stage choke. | _TBD_ | Not started | Uses evidence bundle `2025-09-28-evidence.md` |

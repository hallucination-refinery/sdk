...
| Vertex position logging            | Log sample `revealPos` / `gl_Position` to confirm geometry collapse.        | codex/instrument-vertex-positions-for-debugging (PR #245) | Blocked     | 2025-09-28 vertex-log run emitted no `[vertex]` samples nor tap/stroke telemetry; resolve DEBUG_VERTEX_LOG wiring and settle-time long tasks (51–134 ms frames, 431 long rAF tasks) before rerun.【2025-09-28-vertex-log-raw.md:37-162】 |

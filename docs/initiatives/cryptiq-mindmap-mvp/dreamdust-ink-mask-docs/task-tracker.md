...
|------|-------------|-------------|--------|-------|
| Alpha hardcode probe | Force particle alpha to 1.0 or bypass discard to test fragment-stage choke. | codex/investigate-alpha-choke-in-dreamdust (PR #244) | In review | Uses evidence bundle `2025-09-28-evidence.md`; review alpha-force instrumentation |

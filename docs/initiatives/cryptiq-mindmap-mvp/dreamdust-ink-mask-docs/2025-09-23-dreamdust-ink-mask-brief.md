...
<!-- from apps/cryptiq-mindmap-demo/app/components/dreamdust/useDreamdustUniforms.ts: ENGINE_SIM_VALUE & PRESET_AIRY_VALUE; from apps/cryptiq-mindmap-demo/app/components/PointCloudStage.tsx: readNoBloomOverride -->

- Local: `http://localhost:3000/quiz/archetype-v1?pc=scene-02&debug=1&engine=sim&preset=airy&noBloom=1`
...
<!-- from apps/cryptiq-mindmap-demo/app/components/dreamdust/useDreamdustUniforms.ts: ENGINE_QUERY_KEY & ENGINE_SIM_VALUE -->

- `engine=sim`
<!-- from apps/cryptiq-mindmap-demo/app/components/dreamdust/useDreamdustUniforms.ts: PRESET_QUERY_KEY & PRESET_AIRY_VALUE -->
- `preset=airy`
<!-- from apps/cryptiq-mindmap-demo/app/components/PointCloudStage.tsx: readNoBloomOverride (query: noBloom=1) -->
- `noBloom=1`

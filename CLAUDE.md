...
- **PROMPT:** Read ONLY the exact line range assigned to you in @worktrees/feat-pond-demo-aug14/docs/pond-demo-aug14/guides/prompts.md. That line range _is_ your entire prompt.
- **GUARD BLOCK:** _Do not_ read any other lines in @worktrees/feat-pond-demo-aug14/docs/pond-demo-aug14/guides/prompts.md. If the file or the exact lines are unavailable, _STOP_ and report precisely what is missing.
